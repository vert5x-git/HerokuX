...
eval "cat ~/HerokuX/assets/download.txt"
printf "\n\n\033[1;35mHerokuX is being installed... ✨\033[0m"
...
eval "cd && git clone https://github.com/coddrago/HerokuX && cd HerokuX"
...
if [[ -z "${NO_AUTOSTART}" ]]; then
    ...
    echo 'clear && cd ~/HerokuX && python3 -m hikka' > ~/.bash_profile"
