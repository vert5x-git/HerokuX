...
def get_commit_url() -> str:
    """
    Get current HerokuX git commit url
    :return: Git commit url
    """
    try:
        hash_ = get_git_hash()
        return f'<a href="https://github.com/coddrago/HerokuX/commit/{hash_}">#{hash_[:7]}</a>'
    except Exception:
        return "Unknown"
...
def get_git_info() -> typing.Tuple[str, str]:
    ...
    return (
        hash_,
        f"https://github.com/coddrago/HerokuX/commit/{hash_}" if hash_ else "",
    )
