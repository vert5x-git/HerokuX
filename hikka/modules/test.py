...
class TestMod(loader.Module):
        ...
        self.config = loader.ModuleConfig(
            loader.ConfigValue(
                ...
                (
                    ...
                    " HerokuX will try to determine, which client caused logs. E.g. there"
                    ...
                    " HerokuX will send all logs to Client1 and Client2, even if it is"
    ...
    async def logs(
        ...
        other = (
            *main.__version__,
            (
                " <a"
                f' href="https://github.com/coddrago/HerokuX/commit/{ghash}">@{ghash[:8]}</a>'
                if ghash
                else ""
            ),
        )
    ...
    async def client_ready(self):
        chat, _ = await utils.asset_channel(
            self._client,
            "heroku-logs",
            "🪐 Your HerokuX logs will appear in this chat",
            silent=True,
            invite_bot=True,
            avatar=" https://raw.githubusercontent.com/coddrago/HerokuX/refs/heads/master/assets/heroku-logs.png",
        )
