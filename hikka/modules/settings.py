...
class CoreMod(loader.Module):
    ...
    @loader.command(alias="hikka", ru_doc="Информация о Хероку", en_doc="Information of HerokuX", ua_doc="Інформація про Хероку", de_doc="Informationen über HerokuX")
