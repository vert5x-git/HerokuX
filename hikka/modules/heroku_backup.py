...
@loader.tds
class HerokuXBackupMod(loader.Module):
    """Handles database and modules backups"""

    strings = {"name": "HerokuXBackup"}
    ...
    async def client_ready(self):
        ...
        self._backup_channel, _ = await utils.asset_channel(
            ...
            silent=True,
            archive=True,
            avatar="https://raw.githubusercontent.com/coddrago/HerokuX/refs/heads/master/assets/heroku-backups.png",
            _folder="heroku",
            invite_bot=True,
        )
    ...
    async def handler(self):
        try:
            ...
            logger.exception("HerokuXBackup failed")
